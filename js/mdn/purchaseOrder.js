...
function beforeSavePurchaseOrder(eventObj)
{
...
//*********************************************************************************************************
//method to set status according to the current clicked approve button
function beforeApprovePurchaseOrder()
{
    //Stock current tab in hidden form item
    var currentTabId = purchase_order_tabsJsTabs.activeTab.name;
    document.getElementById('current_tab').value = currentTabId;
    document.getElementById('po_status').disabled = "";
    document.getElementById('po_status').value = "approved";
    //document.getElementById('customaction').value = "approval";
...
//*********************************************************************************************************
//method to set status according to the current clicked complete button
function beforeCompletePurchaseOrder()
{
    //Stock current tab in hidden form item
    var currentTabId = purchase_order_tabsJsTabs.activeTab.name;
    document.getElementById('current_tab').value = currentTabId;
    document.getElementById('po_status').disabled = "";
    document.getElementById('po_status').value = "complete";
    //document.getElementById('customaction').value = "complete";
...
function beforeSendForApprovePurchaseOrder()
{
    //Stock current tab in hidden form item
    var currentTabId = purchase_order_tabsJsTabs.activeTab.name;
    document.getElementById('current_tab').value = currentTabId;
    document.getElementById('po_status').disabled = "";
    document.getElementById('po_status').value = "sent_for_approval";
...
//method to set status according to the current clicked send to approve button
function beforeCancelPurchaseOrder()
{
    //Stock current tab in hidden form item
    var currentTabId = purchase_order_tabsJsTabs.activeTab.name;
    document.getElementById('current_tab').value = currentTabId;
    document.getElementById('po_status').disabled = "";
    document.getElementById('po_status').value = "cancel";
